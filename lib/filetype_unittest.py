...
""",
    ...
    def testBinaryCompressedFiles(self):
        ...
        osutils.WriteFile(
            ...
            b"\xe5\xa3\x01\x00\x04hola\n\x00\x00\x00\x00\xdd\xb0\x00\xac6w~\x9d"
            b"\x00\x01\x1d\x05\xb8-\x80\xaf\x1f\xb6\xf3}\x01\x00\x00\x00\x00"
            b"\x04YZ",
            mode="wb",
        )
        self.assertEqual(
    ...
    def testBinaryMiscFiles(self):
        ...
        osutils.WriteFile(
            some_timezone,
            b"TZif2\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
            b"\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00"
            b"\x00\x00\x00\x01\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00UTC\x00"
            b"\x00\x00TZif2\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
            b"\x00\x00\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00"
            b"\x00\x00\x00\x00\x00\x01\x00\x00\x00\x04\x00\x00\x00\x00\x00"
            b"\x00UTC\x00\x00\x00\nUTC0\n",
            mode="wb",
        )
        self.assertEqual(
