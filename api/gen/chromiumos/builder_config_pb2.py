...
_BUILDERCONFIG_ID_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='INCREMENTAL', index=8, number=8,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_BUILDERCONFIG_ARTIFACTS_ARTIFACTTYPES = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SYSROOT_ARCHIVE', index=50, number=50,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_BUILDERCONFIG_UPDATECHROOT = _descriptor.Descriptor(
  name='UpdateChroot',
  full_name='chromiumos.BuilderConfig.UpdateChroot',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_spec', full_name='chromiumos.BuilderConfig.UpdateChroot.run_spec', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUILDERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update_chroot', full_name='chromiumos.BuilderConfig.update_chroot', index=7,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_BUILDERCONFIG_ID, _BUILDERCONFIG_GENERAL, _BUILDERCONFIG_ORCHESTRATOR, _BUILDERCONFIG_ARTIFACTS, _BUILDERCONFIG_CHROME, _BUILDERCONFIG_BUILD, _BUILDERCONFIG_UNITTESTS, _BUILDERCONFIG_UPDATECHROOT, ],
  enum_types=[
...
_BUILDERCONFIG_UPDATECHROOT.fields_by_name['run_spec'].enum_type = _BUILDERCONFIG_RUNSPEC
_BUILDERCONFIG_UPDATECHROOT.containing_type = _BUILDERCONFIG
...
_BUILDERCONFIG.fields_by_name['update_chroot'].message_type = _BUILDERCONFIG_UPDATECHROOT
...
BuilderConfig = _reflection.GeneratedProtocolMessageType('BuilderConfig', (_message.Message,), {
  ...
  'UpdateChroot' : _reflection.GeneratedProtocolMessageType('UpdateChroot', (_message.Message,), {
    'DESCRIPTOR' : _BUILDERCONFIG_UPDATECHROOT,
    '__module__' : 'chromiumos.builder_config_pb2'
    # @@protoc_insertion_point(class_scope:chromiumos.BuilderConfig.UpdateChroot)
    })
  ,
...
_sym_db.RegisterMessage(BuilderConfig.UpdateChroot)
