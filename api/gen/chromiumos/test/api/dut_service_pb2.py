...
_FETCHFILEREQUEST = _descriptor.Descriptor(
  name='FetchFileRequest',
  full_name='chromiumos.test.api.FetchFileRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='file', full_name='chromiumos.test.api.FetchFileRequest.file', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FILE = _descriptor.Descriptor(
  name='File',
  full_name='chromiumos.test.api.File',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='file', full_name='chromiumos.test.api.File.file', index=0,
...
DESCRIPTOR.message_types_by_name['FetchFileRequest'] = _FETCHFILEREQUEST
...
FetchFileRequest = _reflection.GeneratedProtocolMessageType('FetchFileRequest', (_message.Message,), {
  ...
  '__module__' : 'chromiumos.test.api.dut_service_pb2'
  # @@protoc_insertion_point(class_scope:chromiumos.test.api.FetchFileRequest)
  })
...
File = _reflection.GeneratedProtocolMessageType('File', (_message.Message,), {
  'DESCRIPTOR' : _FILE,
  '__module__' : 'chromiumos.test.api.dut_service_pb2'
  # @@protoc_insertion_point(class_scope:chromiumos.test.api.File)
  })
...
_DUTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='FetchFile',
    full_name='chromiumos.test.api.DutService.FetchFile',
    index=4,
    containing_service=None,
    input_type=_FETCHFILEREQUEST,
    output_type=_FILE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
