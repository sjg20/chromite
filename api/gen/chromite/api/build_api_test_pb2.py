...
_TOTEXECUTIONSERVICE = _descriptor.ServiceDescriptor(
  name='TotExecutionService',
  full_name='chromite.api.TotExecutionService',
  file=DESCRIPTOR,
  index=4,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='chromite.api.TotExecutionService.TotServiceTotMethod',
    index=0,
    containing_service=None,
    input_type=_TESTREQUESTMESSAGE,
    output_type=_TESTRESULTMESSAGE,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='chromite.api.TotExecutionService.TotServiceTotMethodInside',
    index=1,
    containing_service=None,
    input_type=_TESTREQUESTMESSAGE,
    output_type=_TESTRESULTMESSAGE,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='chromite.api.TotExecutionService.TotServiceBranchedMethod',
    index=2,
    containing_service=None,
    input_type=_TESTREQUESTMESSAGE,
    output_type=_TESTRESULTMESSAGE,
    serialized_options=b'\302\355\032\002 \001',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='TotServiceBranchedMethodInside',
    full_name='chromite.api.TotExecutionService.TotServiceBranchedMethodInside',
    index=3,
    containing_service=None,
    input_type=_TESTREQUESTMESSAGE,
    output_type=_TESTRESULTMESSAGE,
...
_sym_db.RegisterServiceDescriptor(_TOTEXECUTIONSERVICE)

DESCRIPTOR.services_by_name['TotExecutionService'] = _TOTEXECUTIONSERVICE
