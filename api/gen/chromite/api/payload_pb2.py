...
_GENERATIONRESPONSE_VERSIONEDARTIFACT = _descriptor.Descriptor(
  name='VersionedArtifact',
  full_name='chromite.api.GenerationResponse.VersionedArtifact',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='chromite.api.GenerationResponse.VersionedArtifact.version', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='local_path', full_name='chromite.api.GenerationResponse.VersionedArtifact.local_path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remote_uri', full_name='chromite.api.GenerationResponse.VersionedArtifact.remote_uri', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='local_path', full_name='chromite.api.GenerationResponse.local_path', index=0,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='remote_uri', full_name='chromite.api.GenerationResponse.remote_uri', index=1,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='versioned_artifacts', full_name='chromite.api.GenerationResponse.versioned_artifacts', index=2,
  ...
  nested_types=[_GENERATIONRESPONSE_VERSIONEDARTIFACT, ],
  enum_types=[
...
_GENERATIONRESPONSE_VERSIONEDARTIFACT.containing_type = _GENERATIONRESPONSE
_GENERATIONRESPONSE.fields_by_name['versioned_artifacts'].message_type = _GENERATIONRESPONSE_VERSIONEDARTIFACT
