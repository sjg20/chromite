...
_CREATEMANIFESTFROMSDKREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sdk_tarball_path', full_name='chromite.api.CreateManifestFromSdkRequest.sdk_tarball_path', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEMANIFESTFROMSDKREQUEST.fields_by_name['sdk_tarball_path'].message_type = chromiumos_dot_common__pb2._PATH
