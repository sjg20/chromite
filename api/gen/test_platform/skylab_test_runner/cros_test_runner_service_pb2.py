...
_EXECUTEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='path_to_cipd_bin', full_name='test_platform.skylab_test_runner.ExecuteRequest.path_to_cipd_bin', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='artifacts_path', full_name='test_platform.skylab_test_runner.ExecuteRequest.artifacts_path', index=4,
