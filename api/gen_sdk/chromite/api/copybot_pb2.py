...
_RUNCOPYBOTREQUEST_PUSHOPTION = _RUNCOPYBOTREQUEST.nested_types_by_name['PushOption']
...
RunCopybotRequest = _reflection.GeneratedProtocolMessageType('RunCopybotRequest', (_message.Message,), {
  ...
  'PushOption' : _reflection.GeneratedProtocolMessageType('PushOption', (_message.Message,), {
    'DESCRIPTOR' : _RUNCOPYBOTREQUEST_PUSHOPTION,
    '__module__' : 'chromite.api.copybot_pb2'
    # @@protoc_insertion_point(class_scope:chromite.api.RunCopybotRequest.PushOption)
    })
  ,
...
_sym_db.RegisterMessage(RunCopybotRequest.PushOption)
